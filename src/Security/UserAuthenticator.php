...
class UserAuthenticator extends AbstractFormLoginAuthenticator
{
    ...
    {
//        This is written by default by Symfony when we create AuthEntity but as we authenticate via AD this following line as no use.
//        return $this->passwordEncoder->isPasswordValid($user, $credentials['password']);
    ...
    {
        // the param $token as no use but we leave it like this as it's generated by default
